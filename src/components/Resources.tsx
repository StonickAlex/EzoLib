...
const resources: Array<Resource> = [
  {
    href: '/docs/magic-basics',
    name: 'Основы магии',
    description:
      'Изучение базовых принципов магических практик, элементов и любовной магии.',
    icon: BookIcon,
    pattern: {
      y: 16,
      squares: [
  ...
  {
    href: '/docs/numerology',
    name: 'Нумерология',
    description:
      'Работа с числами, датами рождения и их влиянием на судьбу человека.',
    icon: ShapesIcon,
    pattern: {
      y: -6,
      squares: [
  ...
  },
  {
    ...
    name: 'Таро',
    description:
      'Искусство гадания на картах Таро и их интерпретация.',
    icon: DocumentIcon,
    pattern: {
      y: 32,
      squares: [
  ...
  },
  {
    ...
    name: 'Астрология',
    description:
      'Изучение влияния звезд и планет на жизнь человека.',
    icon: BoltIcon,
    pattern: {
      y: 22,
      squares: [[0, 1]],
  ...
  },
  {
    ...
    name: 'Обряды',
    description:
      'Практические магические обряды и ритуалы.',
    icon: CogIcon,
    pattern: {
      y: -6,
      squares: [
  ...
  {
    href: '/docs/conversation-schema',
    name: 'Схема разговора',
    description:
      'Техники ведения диалога с клиентами и диагностики.',
    icon: ChatBubbleIcon,
    pattern: {
      y: 32,
      squares: [
  ...
  },
  {
    ...
    description:
      'Методы преодоления сомнений и возражений клиентов.',
    icon: UserIcon,
    pattern: {
      y: 22,
      squares: [[0, 1]],
  ...
  {
    href: '/docs/date-birth',
    name: 'Работа с датой рождения',
    description:
      'Специализированные техники анализа дат рождения.',
    icon: CalendarIcon,
    pattern: {
      y: 16,
      squares: [
